...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nestedFunction is able to access internal because of closure.
...
function summation(num) {
  /*Your Code Here*/
  let sumArr = [];
  let sum = num.reduce(function(acc, item){
     return acc + item; 
    }, 0);
    return 
}
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(arr){
    /*Your Code Here*/
    const singleValue = arr.reduce(function(accumulator, item){
